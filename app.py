...
vereinsdata={
    "query_teams_end_of_season":1,
    "query_spiele_spieler":2,
    "query_spiele_statistics":3,
    "query_goals_per_min":4,
    "query_points_per_league_season_round_team":5,
}
...
if __name__ == '__main__':
    ...
    def load_data():
        ...
        return render_template('data.html', iframe=f"/dtale/main/{vereinsdata[dataset]}")
